...
const Navbar = () => {
  ...
  return (
    <section className="py-0 px-0 lg:px-0 ">
      <nav className="flex w-full lg:justify-center justify-end items-center bg-black bg-opacity-90">
        <div className="hidden lg:block mr-20">
          <ul className="flex items-center text-red space-x-10">
            <li>
              <Link href="/">
                <p className="text-yellow-500 font-bold text-2xl cursor-pointer">Mint A NFT</p>
              </Link>
            </li>
            <span>
            ...
            <li>
              <Link href="/gallery">
                <p className="text-yellow-500 font-bold text-2xl cursor-pointer">My Collection</p>
              </Link>
            </li>
            <span>
              <svg width="5" height="5" viewBox="0 0 5 5" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
              <Link href="/attributes">
                <p className="text-yellow-500 font-bold text-2xl cursor-pointer">Attributes</p>
              </Link>
            </li>
            <span>
              <svg width="5" height="5" viewBox="0 0 5 5" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
              <Link href="/faq">
                <p className="text-yellow-500 font-bold text-2xl cursor-pointer">FAQ</p>
              </Link>
            </li>
            <span>
              <svg width="5" height="5" viewBox="0 0 5 5" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
              <Link href="/roadmap">
                <p className="text-yellow-500 font-bold text-2xl cursor-pointer">Roadmap</p>
              </Link>
            </li>
            <span>
              <svg width="5" height="5" viewBox="0 0 5 5" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className={`${mobileMenu ? 'block' : 'hidden'} navbar-menu relative z-50`}>
        <div className="navbar-backdrop fixed inset-0 bg-black opacity-90"></div>
        <nav className="fixed top-0 right-0 bottom-0 flex flex-col w-full max-w-sm py-8 bg-gray-800 overflow-y-auto">
          ...
          <div className="flex justify-center">
            <ul>
              ...
              <li className="mb-1 px-10">
                <Link href="/gallery">
                  <p className="text-yellow-500 font-bold text-2xl cursor-pointer">My Gallery</p>
                </Link>
              </li>
              <li className="mb-1 px-10">
                <Link href="/faq">
