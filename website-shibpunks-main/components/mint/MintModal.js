...
const MintModal = ({ forceReload, setForceReload }) => {
  ...
  return (
    <div className="flex flex-col">
      <div className="bg-black opacity 90 shadow-md rounded-3xl p-4">
        <div className="flex-none lg:flex">
          ...
          <div className="flex-auto ml-3 justify-evenly py-2">
            <div className="flex flex-wrap ">
              <div className="w-full flex-none text-xs text-yellow-500 font-medium ">NFTs</div>
              <div className="text-black">
                <span className="text-3xl text-yellow-500 font-medium">Mint </span>
                <button className="text-4xl text-yellow-500" onClick={() => updateNFTMint('minus')}>
                  -
                </button>
                <span className="text-4xl px-2 text-yellow-500">{NFTMintNumber}</span>
                <button className="text-4xl text-yellow-500" onClick={() => updateNFTMint('add')}>
                  +
                </button>
                {!isLoading && <span className="text-3xl text-yellow-500"> @ {NFTMintNumber == 1 ? '0.20' : numeral(dataFetch.price.bnb * NFTMintNumber).format('0[.]00')} BNB</span>}
              </div>
            </div>
            <p className="mt-3"></p>
