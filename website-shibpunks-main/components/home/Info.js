...
const Info = () => {
  return (
    <div className="container justify-center flex flex-col mx-auto max-w-6xl">
      <h3 className="font-bold my-4 text-center text-wrap text-3xl bg-black opacity 90 rounded-3xl text-yellow-400 p-4">
      ...
      <h3 className="font-black my-10 text-center text-yellow-500 text-6xl drop-shadow-xl textglow-dark">What makes NFTs so unique?</h3>
      <div className="text-yellow-500 text-3xl px-10 text-center mx-auto mb-12 bg-black rounded-3xl py-4">
