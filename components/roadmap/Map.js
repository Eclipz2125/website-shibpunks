...
const Map = () => {
  return (
    <div className="container bg-none mx-auto w-full h-full">
      <h3 className="font-bold my-8 text-center text-white text-5xl textglow">
        Roadmap
      </h3>
      <div className="flex flex-col md:grid grid-cols-9 mx-auto p-2 mb-8 pb-4 text-black">
        <div className="flex flex-row-reverse md:contents">
          <div className="bg-white Opacity 85 col-start-2 col-end-5 p-4 rounded-3xl my-8 ml-auto shadow-lg">
          ...
          <div className="col-start-5 col-end-6 md:mx-auto relative mr-10">
            <div className="h-full w-6 flex items-center justify-center">
              <div className="h-full w-1 bg-white Opacity 85 pointer-events-none"></div>
            </div>
