...
const ClaimContent = ({ forceReload, setForceReload }) => {
  ...
  return (
    <section>
      <div className="text-center text-2xl px-8 mx-8 mt-4 bg-white rounded-3xl p-4 text-black">
        <h2 className="text-center text-3xl text-black font-medium">Your Auto Rewards</h2>
        {connected ? (
          userData.userBal > 0 ? (
            <p>
