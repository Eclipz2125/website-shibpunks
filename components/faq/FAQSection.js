      ...
      <div className="container px-4 mx-auto">
        <div className="container mx-auto px-4">
          <div className="mb-16 max-w-xl mx-auto text-center">
            <h2 className="text-5xl font-bold text-white textglow-dark">Frequently Asked Questions</h2>
          </div>
        </div>
        <div className="flex flex-wrap -mx-4 text-black text-center pt-4 bg-white rounded-3xl">
