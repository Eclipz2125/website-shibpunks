    ...
    <div className="max-w-6xl mx-auto mb-10 my-8">
      <div className="container mx-auto px-4">
        <div className="mb-16 max-w-xl mx-auto text-center">
          <h2 className="text-6xl font-bold text-white textglow-dark">Disclaimer</h2>
        </div>
      </div>
      <div className="text-black text-3xl px-10 text-center mx-auto mb-14 bg-white rounded-3xl py-4">
        <p className="my-2">
